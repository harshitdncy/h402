...
function HomeContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Navigate to the image page with the prompt as a parameter
    // The image page will handle the API call and payment flow
            ...
            >
              ...
              >
                {isGenerating ? (
                  <>
                    <svg
                      className="inline-block animate-spin -ml-1 mr-2 h-5 w-5"

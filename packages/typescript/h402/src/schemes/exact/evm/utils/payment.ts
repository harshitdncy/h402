import { safeBase64Encode, safeBase64Decode } from "../../../../utils/index.js";
import type {
...
function decodePayment(payment: string): PaymentPayload<Payload> {
...
export { encodePayment, decodePayment };

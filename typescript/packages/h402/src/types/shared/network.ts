...
export const SupportedSolanaNetworks: SolanaNetwork[] = [
  "solana",
];
...
export const isSupportedEVMNetworkId = (networkId: number | string): boolean => {
...
export const getEVMNetworkById = (networkId: number | string): EVMNetwork | undefined => {
  const id = typeof networkId === 'string' ? parseInt(networkId, 10) : networkId;
